            ...
            <div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <input type="text" value="linkedin.com/in/arjun-sharma" readOnly className="flex-1 h-10 border-b border-gray-200 text-sm font-medium text-gray-600 focus:outline-none focus:border-primary bg-transparent" />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <input type="text" value="github.com/arjun-dev" readOnly className="flex-1 h-10 border-b border-gray-200 text-sm font-medium text-gray-600 focus:outline-none focus:border-primary bg-transparent" />
